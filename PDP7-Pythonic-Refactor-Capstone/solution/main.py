...
SAMPLE_ARTICLES = [
    {
        RAW_TITLE_FIELD: " Hello World ",
        RAW_KIND_FIELD: BLOG_KIND,
        RAW_BODY_FIELD: " Python Patterns ",
    },
    {
        RAW_TITLE_FIELD: "System Update",
        RAW_KIND_FIELD: NEWS_KIND,
        RAW_BODY_FIELD: " adapters and facades ",
    },
]
