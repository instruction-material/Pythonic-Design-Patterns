# PDP1 Why Python Changes the Design-Patterns Conversation supplemental 2

Course: Pythonic Design Patterns
Module: PDP1 Why Python Changes the Design-Patterns Conversation supplemental 2
...
Quick run hint: `python3 main.py`
