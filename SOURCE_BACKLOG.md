...
| --- | --- | --- |
| `PDP-25-applied-studio-14-ai-level-1-supplemental-2` | inactive-source-candidate | Inactive/promotable source. Do not link until the course text, starter/solution role, and verification expectation are added. |
| `PDP-26-applied-studio-14-ai-level-1-supplemental-3` | inactive-source-candidate | Inactive/promotable source. Do not link until the course text, starter/solution role, and verification expectation are added. |
| `PDP-27-applied-studio-15-ai-level-2-supplemental-2` | inactive-source-candidate | Inactive/promotable source. Do not link until the course text, starter/solution role, and verification expectation are added. |
| `PDP-28-applied-studio-15-ai-level-2-supplemental-3` | inactive-source-candidate | Inactive/promotable source. Do not link until the course text, starter/solution role, and verification expectation are added. |
| `PDP-29-applied-studio-16-customized-supplemental-2` | legacy-or-archive | Legacy/archive material. Preserve for reference; do not link as active coursework without explicit migration. |
